...
//какой экран использовать, LCD или OLED ---------------------------------------------------------------
#define OLED 1              // 1 - использование OLED дисплея, 0 - LCD дисплей

// Настройки для экрана oled ---------------------------------------------------------------------------
#define ROTATE 0            // разворот на 180 градусов: 0 - не разворачивать, 1 - развернуть на 180
#define OLED128x32 0        // переключение для размеров экрана: 0 - 128х64, 1 - 128х32

// Настройка количества выводимых строк и стартовой позиции в зависимости от экрана--------------------
#if (OLED128x32 == 1) //в этой строке не менять!
...
#if (OLED == 0) //в этой строке не менять!
...
#define INDEX     PB1   // pin 8,  INDEX                                        (OUTPUT)

#define WG        PC0   // pin 0 , WRITE GATE                                   (INPUT)
